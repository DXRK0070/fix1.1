...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<View>(R.id.btnSavePassphrase).setOnClickListener {
            ...
            requireAuth("Confirm it's you", "Changing the export passphrase", onSuccess = {
        ...
        findViewById<View>(R.id.btnShowPassphrase).setOnClickListener {
            requireAuth("Confirm it's you", "Revealing the export passphrase", onSuccess = {
        ...
        lockSwitch.setOnCheckedChangeListener { _, isChecked ->
            ...
            if (isChecked) {
                requireAuth("Confirm it's you", "Turning on app lock", {
                ...
                requireAuth("Confirm it's you", "Turning off app lock", {
    ...
    private fun requireAuth(title: String, subtitle: String, onSuccess: () -> Unit, onFail: (() -> Unit)? = null) {
        if (BiometricGate.isAvailable(this)) {
            BiometricGate.prompt(this, title, subtitle, onSuccess) {
    ...
    private fun tryUnlock() {
        ...
        BiometricGate.prompt(this, "Unlock Biz Logger", "", onSuccess = {
